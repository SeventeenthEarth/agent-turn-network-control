...
RUNFIX implementation tasks after accepted RUNFIX-001/RUNFIX-002 docs-only SOT locks require separate 주군 authorization before implementation starts. `RUNFIX-003`, `RUNFIX-004`, and `RUNFIX-005` are completed as local/control implementation proofs only; `RUNFIX-005` closeout is backed by Red `t_1d5692f1`, Orange `t_388bb347`, Gray `t_6fb40282`, Blue synthesis `t_1eb87c6b`, and KAH run `run-20260618T020120Z-fe2144618fe6`; `plugin/RUNFIX-006`, `plugin/RUNFIX-007`, and `plugin/RUNFIX-008` now have local implementation proof under plugin KAH runs `run-20260618T045937Z-2e173b8309f3`, `run-20260618T081811Z-23d10e2a4634`, and `run-20260618T092359Z-401d6e5bedc0`; `control/RUNFIX-009` now has local implementation proof under control KAH run `run-20260618T102752Z-7d8ccfa584e4`. These proofs still do not authorize apply/live-local pilot, live readiness, production activation, live Discord delivery, daemon startup/discovery, plugin/RUNFIX-010 execution, or profile/provider/gateway/auth/token/model mutation. `RUNFIX-010` remains planned and still requires separate live-local authorization and evidence gates.
