...
27. `27-agent-turn-network-control-naming-sot.md` — control-side Agent Turn Network naming SOT for `ATN`, public rename boundaries, clean no-alias policy, and ATN-001..ATN-005 task sequencing
...
16. `27-agent-turn-network-control-naming-sot.md` when planning `ATN` public rename work
17. plugin docs in the local workspace path `../../agent-turn-network-plugin/docs/`; the public repo label is `atn-plugin`, ATN-001/ATN-002/ATN-003 define the public docs baseline, ATN-004 is completed for control code/runtime naming, and ATN-005 is completed for plugin package/tool/skill naming and guardrails
