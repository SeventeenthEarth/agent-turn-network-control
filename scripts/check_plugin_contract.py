...
REQUIRED_COUNCIL_LIFECYCLE_FIXTURES = [
    ...
    "fixtures/command/council-drop-request.json",
    "fixtures/command/council-drop-response.json",
    ...
    "fixtures/event/hand-raise-dropped-council.json",
    ...
    "fixtures/error/council-hand-raise-wants-false-rejected.json",
