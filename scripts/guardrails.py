...
ACCEPTED_HITS = [
    # Local workspace paths retained until HUN-014 hosted/local rename compatibility closes.
    accepted_hit("README.md", "kkachi-agent-network-plugin", r"local sibling workspace.*kkachi-agent-network-plugin.*HUN-014", "local-workspace-until-HUN-014", r"kkachi-agent-network-plugin"),
    accepted_hit("README.md", "kkachi-agent-network-plugin", r"current workspace path.*kkachi-agent-network-plugin.*HUN-011", "local-workspace-until-HUN-014", r"kkachi-agent-network-plugin"),
    AcceptedHit("docs/00-overview.md", "kkachi-agent-network-plugin", re.compile(r"companion plugin repository: .*kkachi-agent-network-plugin"), "local-workspace-until-HUN-014"),
    AcceptedHit("docs/09-implementation-epics.md", "kkachi-agent-network-plugin", re.compile(r"plugin-specific implementation epics live in .*kkachi-agent-network-plugin"), "local-workspace-until-HUN-014"),
    AcceptedHit("docs/09-implementation-epics.md", "kkachi-agent-network-plugin", re.compile(r"control epics that gate companion plugin epics in .*kkachi-agent-network-plugin"), "local-workspace-until-HUN-014"),
    AcceptedHit("docs/09-implementation-epics.md", "kkachi-agent-network-plugin", re.compile(r"companion consumer work in .*kkachi-agent-network-plugin"), "local-workspace-until-HUN-014"),
    AcceptedHit("docs/11-distribution-and-skill.md", "kkachi-agent-network-plugin", re.compile(r"Hermes plugin packaging.*kkachi-agent-network-plugin"), "local-workspace-until-HUN-014"),
    AcceptedHit("docs/19-tooling.md", "kkachi-agent-network-plugin", re.compile(r"Python Hermes plugin tooling lives in .*kkachi-agent-network-plugin"), "local-workspace-until-HUN-014"),
    AcceptedHit("docs/21-cross-repo-development.md", "kkachi-agent-network-plugin", re.compile(r"plugin-side companion is .*kkachi-agent-network-plugin"), "local-workspace-until-HUN-014"),
    AcceptedHit("docs/22-deleg-002-conformance-fixture-matrix.md", "kkachi-agent-network-plugin", re.compile(r"current local workspace path .*kkachi-agent-network-plugin.*HUN-014"), "local-workspace-until-HUN-014"),
    AcceptedHit("docs/24-live-transport-control-sot.md", "kkachi-agent-network-plugin", re.compile(r"plugin-side companion SOT is .*kkachi-agent-network-plugin"), "local-workspace-until-HUN-014"),
    AcceptedHit("docs/24-live-transport-control-sot.md", "kkachi-agent-network-plugin", re.compile(r"cd \.\./kkachi-agent-network-plugin && make check-core-contract"), "local-workspace-until-HUN-014"),
    AcceptedHit("docs/20-discord-thread-council-tobe.md", "kkachi-agent-network-plugin", re.compile(r"Plugin bootstrap follows .*kkachi-agent-network-plugin"), "local-workspace-until-HUN-014"),
    AcceptedHit("docs/README.md", "kkachi-agent-network-plugin", re.compile(r"workspace documentation at .*kkachi-agent-network-plugin.*HUN-014"), "local-workspace-until-HUN-014"),
    AcceptedHit("docs/README.md", "kkachi-agent-network-plugin", re.compile(r"local workspace path .*kkachi-agent-network-plugin.*HUN-014"), "local-workspace-until-HUN-014"),
    AcceptedHit("docs/kkachi-docs-map.yaml", "kkachi-agent-network-plugin", re.compile(r'local_plugin_workspace: "../kkachi-agent-network-plugin"'), "local-workspace-until-HUN-014"),
    AcceptedHit("docs/kkachi-docs-map.yaml", "kkachi-agent-network-plugin", re.compile(r'plugin_sot: "../kkachi-agent-network-plugin/'), "local-workspace-until-HUN-014"),
    AcceptedHit("docs/kkachi-docs-map.yaml", "kkachi-agent-network-control", re.compile(r'graph_id: "graph-kkachi-project-kkachi-agent-network-control'), "local-workspace-until-HUN-014"),
    AcceptedHit("docs/roadmap.md", "kkachi-agent-network-plugin", re.compile(r"Python Hermes plugin roadmap items live in .*kkachi-agent-network-plugin"), "local-workspace-until-HUN-014"),
    AcceptedHit("docs/roadmap.md", "kkachi-agent-network-plugin", re.compile(r"plugin-owned rows live in .*kkachi-agent-network-plugin"), "local-workspace-until-HUN-014"),
    AcceptedHit("docs/roadmap.md", "kkachi-agent-network-plugin", re.compile(r"plugin-owned implementation authority remains in .*kkachi-agent-network-plugin"), "local-workspace-until-HUN-014"),
    AcceptedHit("scripts/check_plugin_contract.py", "kkachi-agent-network-plugin", re.compile(r'KAN_PLUGIN_REPO.*kkachi-agent-network-plugin'), "local-workspace-until-HUN-014"),
    AcceptedHit("scripts/ltran003_live_local_smoke.py", "kkachi-agent-network-plugin", re.compile(r'sibling_plugin = root.parent / "kkachi-agent-network-plugin"'), "local-workspace-until-HUN-014"),
    AcceptedHit("testdata/conformance/README.md", "kkachi-agent-network-plugin", re.compile(r"consumed by `kkachi-agent-network-plugin`"), "local-workspace-until-HUN-014"),
    AcceptedHit("testdata/conformance/manifest.json", "kkachi-agent-network-plugin", re.compile(r'"consumer_repo": "kkachi-agent-network-plugin"'), "local-workspace-until-HUN-014"),
    # Local repo identity remains in static conformance metadata until HUN-014 closes hosted/local rename compatibility.
    AcceptedHit("testdata/conformance/manifest.json", "kkachi-agent-network-control", re.compile(r'"owner_repo": "kkachi-agent-network-control"'), "local-workspace-until-HUN-014"),
