...
ACCEPTED_HITS = [
    ...
    accepted_hit("docs/09-implementation-epics.md", "kan_discussion", r"pure/local `kan_discussion_activation_plan`", "historical/provenance", r"; `kan_discussion_activation_plan`", 171),
    accepted_hit("docs/09-implementation-epics.md", "kan_discussion", r"extends the existing pure/local `kan_discussion_activation_plan`", "historical/provenance", r"tools; `kan_discussion_activation_plan`", 172),
